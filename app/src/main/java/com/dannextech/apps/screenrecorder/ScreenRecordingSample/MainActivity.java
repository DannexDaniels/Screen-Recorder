package com.dannextech.apps.screenrecorder.ScreenRecordingSample;
...
import com.dannextech.apps.screenrecorder.R;
import com.dannextech.apps.screenrecorder.Service.ScreenRecorderService;

import java.lang.ref.WeakReference;

/**
 * Created by Dannex Daniels on 12/8/2017.
 */
...
public class MainActivity extends Activity{
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        if (DEBUG) Log.e(TAG, "onActivityResult:resultCode=" + resultCode + ",data=" + data);
    ...
    private void queryRecordingStatus() {
        if (DEBUG) Log.e(TAG, "queryRecording:");
    ...
    private void updateRecording(final boolean isRecording, final boolean isPausing) {
        if (DEBUG) Log.e(TAG, "updateRecording:isRecording=" + isRecording + ",isPausing=" + isPausing);
    ...
    private static final class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            if (DEBUG) Log.e(TAG, "onReceive:" + intent);
